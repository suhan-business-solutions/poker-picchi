...
/**
 * Provides the local service interface for BuyOut. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jpnaidu
 * @see BuyOutLocalServiceUtil
...
public interface BuyOutLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BuyOutLocalServiceUtil} to access the BuyOut local service. Add custom service methods to {@link com.sbs.pokerp.service.impl.BuyOutLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
