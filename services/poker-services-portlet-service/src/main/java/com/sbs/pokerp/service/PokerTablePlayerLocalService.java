...
/**
 * Provides the local service interface for PokerTablePlayer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jpnaidu
 * @see PokerTablePlayerLocalServiceUtil
...
public interface PokerTablePlayerLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link PokerTablePlayerLocalServiceUtil} to access the PokerTablePlayer local service. Add custom service methods to {@link com.sbs.pokerp.service.impl.PokerTablePlayerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
