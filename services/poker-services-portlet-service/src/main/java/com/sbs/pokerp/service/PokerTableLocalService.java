...
/**
 * Provides the local service interface for PokerTable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jpnaidu
 * @see PokerTableLocalServiceUtil
...
public interface PokerTableLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link PokerTableLocalServiceUtil} to access the PokerTable local service. Add custom service methods to {@link com.sbs.pokerp.service.impl.PokerTableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
